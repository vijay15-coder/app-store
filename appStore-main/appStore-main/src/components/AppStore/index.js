...
class AppStore extends Component {
  ...
  getFilteredAppsList = activeTabId => {
  ...
  getSearchInputMatchingApps = filteredAppsList => {
    const {searchInput} = this.state
    const matchingAppsList = filteredAppsList.filter(app => {
      const temp = app.appName.toLowerCase()
  ...
  render() {
    ...
    const filteredAppsList = this.getFilteredAppsList(activeTabId)
    const searchInputMatchingApps = this.getSearchInputMatchingApps(
      filteredAppsList,
    )
        ...
        <div className="bg-container">
          <div className="apps-card">
            ...
            <ul className="apps-container">
              {searchInputMatchingApps.map(eachApp => (
